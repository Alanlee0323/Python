...
folder_path = "C:\\Users\\alana\\Desktop\\AIGO\\aigo_choose\\AllLabelled_Copy_relabel" #存放Labels路径
classes_file = "C:\\Users\\alana\\Desktop\\Aigo\\relabelclasses.txt" #存放类别文件路径
...
for item in file_list:
    ...
    if item.split('.')[3] == "txt" and item != "classes.txt":
